<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Irakasleak.aspx.vb" Inherits="ErabiltzaileErregistratuak.Irakasleak" %>
        ...
        <div style="margin:auto;width:1100px">
            <asp:Panel runat="server" style="background:#97bee6;float:left;margin:15px;padding:10px;border-radius:3px;border: 3px solid #7596b8;" Width="230px" height="500px">
                <div style="padding-left:20px;">
                    <h2>Irakasgaiak</h2>
                    <asp:HyperLink id="hyperlink1" NavigateUrl="IrakasleLanak.aspx" runat="server"><h2>Lanak</h2></asp:HyperLink>
                    <h2>Taldeak</h2>
